...
To create a new plan directly from an existing segment, do the following:  
...
1. Click **Start new plan**.  
  The **New plan** page displays.  
1. Follow the instructions given under [Creating new plans](CreatingNewPlans.md).  
